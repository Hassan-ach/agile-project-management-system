...
@Component
public class RemoveStoryFromSprintBackLogUseCase extends BaseUseCase<UpdateStorySprintRequest, SprintBackLogResponse>{

    
    private final SprintBackLogRepository sprintBackLogRepository;
    private final UserStoryRepository userStoryRepository;

    public RemoveStoryFromSprintBackLogUseCase(
