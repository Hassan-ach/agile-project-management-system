...
@Component
public class UnLinkStoryToEpicUseCase
    extends BaseUseCase<UserStoryEpicUpdateRequest, UserStoryResponse> {

    private final EpicRepository epicRepository;
    private final UserStoryRepository userStoryRepository;

    public UnLinkStoryToEpicUseCase(ITransactionalWrapper tr, EpicRepository er,
